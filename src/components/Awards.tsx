        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              {awards.map((award, i) => (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${award.color} flex items-center justify-center flex-shrink-0 shadow-lg text-xl`}
                  >
                    {award.icon}
                  </div>
                  <div>
                    ...
                    <span
                      className={`mt-2 inline-block text-xs font-medium px-3 py-1 rounded-full bg-gradient-to-r ${award.color} text-white`}
                    >
                      {award.org}
                    </span>
                  </div>
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              >
                <div
                  className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${education.color} flex items-center justify-center mb-5 shadow-lg`}
                >
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={domain}
                    className="px-3 py-1.5 rounded-xl text-sm font-medium glass-card text-slate-300"
                  >
                    {domain}
                  </span>
                ))}
